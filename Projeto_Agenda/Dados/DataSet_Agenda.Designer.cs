...
namespace Projeto_Agenda.Dados {
    ...
    public partial class DataSet_Agenda : global::System.Data.DataSet {
        ...
        public partial class USUARIODataTable : global::System.Data.TypedTableBase<USUARIORow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public USUARIORow AddUSUARIORow(string Nome_Usuario, int Nivel, string Senha) {
...
SELECT ID, Nome, Endereço, Cidade, Email, Data_Nascimento FROM Pessoa_M WHERE (ID = @ID)";
    ...
    public partial class USUARIOTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[USUARIO] WHERE (([ID] = @Original_ID) AND ([Nome_Usuario] = @O" +
                "riginal_Nome_Usuario) AND ([Nivel] = @Original_Nivel) AND ([Senha] = @Original_S" +
                "enha))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[USUARIO] ([Nome_Usuario], [Nivel], [Senha]) VALUES (@Nome_Usua" +
                "rio, @Nivel, @Senha);\r\nSELECT ID, Nome_Usuario, Nivel, Senha FROM USUARIO WHERE " +
                "(ID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[USUARIO] SET [Nome_Usuario] = @Nome_Usuario, [Nivel] = @Nivel, [Senha] = @Senha WHERE (([ID] = @Original_ID) AND ([Nome_Usuario] = @Original_Nome_Usuario) AND ([Nivel] = @Original_Nivel) AND ([Senha] = @Original_Senha));
SELECT ID, Nome_Usuario, Nivel, Senha FROM USUARIO WHERE (ID = @ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID, Nome_Usuario, Nivel, Senha FROM dbo.USUARIO";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSet_Agenda.USUARIODataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet_Agenda.USUARIODataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet_Agenda.USUARIODataTable dataTable = new DataSet_Agenda.USUARIODataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        public virtual DataSet_Agenda.USUARIODataTable Procurar_Usuario(string Usuario, string Senha) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet_Agenda.USUARIODataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ID, string Original_Nome_Usuario, int Original_Nivel, string Original_Senha) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Nome_Usuario, int Nivel, string Senha) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome_Usuario, int Nivel, string Senha, int Original_ID, string Original_Nome_Usuario, int Original_Nivel, string Original_Senha, int ID) {
            if ((Nome_Usuario == null)) {
                throw new global::System.ArgumentNullException("Nome_Usuario");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome_Usuario, int Nivel, string Senha, int Original_ID, string Original_Nome_Usuario, int Original_Nivel, string Original_Senha) {
            return this.Update(Nome_Usuario, Nivel, Senha, Original_ID, Original_Nome_Usuario, Original_Nivel, Original_Senha, Original_ID);
        }
    }
